...
echo "Definindo Permissoes arquivos"
if 
        chmod +rwx /home/"$nome_user"/Downloads/Padrao_mint_20/geral/skel.tar.gz;
    then
...
#tema de inicializacao

echo Instalando tema de inicializacao..
echo Na instalação selecione o numero do tema bmpr
pause 'Pressione [Enter] para continuar'
if 
    tar -xvzf /home/"$nome_user"/Downloads/Padrao_mint_20/geral/bmpr-plymouth.tar.gz -C /usr/share/plymouth/themes/;
    update-alternatives --install /usr/share/plymouth/themes/default.plymouth default.plymouth /usr/share/plymouth/themes/bmpr-plymouth/bmpr-plymouth.plymouth 100;
...
if 
    tar -vzxf /home/"$nome_user"/Downloads/Padrao_mint_20/geral/skel.tar.gz -C /etc/skel
    cp /home/"$nome_user"/Downloads/Padrao_mint_20/imagens/sele_ring.jpg /usr/share/backgrounds/linuxmint;
    cp /home/"$nome_user"/Downloads/Padrao_mint_20/imagens/sele_linuxmint_center.jpg /usr/share/backgrounds/linuxmint;
    cp /home/"$nome_user"/Downloads/Padrao_mint_20/imagens/brasao_redondo.png /usr/share/icons;
...
if
        cp /home/"$nome_user"/Downloads/Padrao_mint_20/geral/conky/conky.conf /etc/conky/;
        cp /home/"$nome_user"/Downloads/Padrao_mint_20/geral/conky/conky.conf ~/.conkyrc;
        cp /home/"$nome_user"/Downloads/Padrao_mint_20/geral/conky/conky.desktop /home/"$nome_user"/.config/autostart/;
...
if
        ...
        cp /home/"$nome_user"/Downloads/Padrao_mint_20/geral/x11vnc.service /lib/systemd/system/;
